...
public class DBAcess1 {
	...
	public int addProgram(CProgram program) throws SQLException{
		...
		PreparedStatement preparedStmt = conn.prepareStatement(query);
	     ...
	     preparedStmt.setInt(3, program.getpSeats());
	     preparedStmt.setInt(4, program.getpSemesters());
	...
	public int updateProgram(CProgram program) throws Exception{
		int count=0;
			 String query = "update Programs set Name=?, Max_Seats=?, Semesters=? where ID=?";
		     PreparedStatement preparedStmt = conn.prepareStatement(query);
		     preparedStmt.setString(1, program.getpName());
		     preparedStmt.setInt(2, program.getpSeats());
		     preparedStmt.setInt(3, program.getpSemesters());
	...
	protected CProgram getProgram() throws SQLException{
		...
		if(rs!=null) {
			...
			program.setpSeats(rs.getInt("Max_Seats"));
			program.setpSemesters(rs.getInt("Semesters"));
		}
		return program;
